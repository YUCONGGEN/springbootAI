...
# Lombok-style model annotations: generate model plumbing while keeping
# ordinary Python methods visible for debugging and extension.
from .lombok import Data, Get, Set, ToString
...
__all__ = [
    ...
    "Secured",
    "Authenticate",
    # Lombok-style model annotations
    "Data",
    "Get",
    "Set",
    "ToString",
